    ...
    <div class="card mt-3" style="width: 1000px;">
        <div class="card-body p-4">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button class="btn btn-outline text-white" type="submit" onclick="return confirm('Update the carousel?')" style="float:right; background-color: #717C73;">Update</button>
            </form>
        </div>
    </div>
