            ...
            <div class="card-body p-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <p style="font-size: 20px;">PURCHASE A LICENSE</p>
                        <p>
                        ...
                        <p style="font-size: 33px;">
                            ...
                            @else 
                                ₱{{$product->price}} 
                            @endif <span style="font-size: 20px;">PHP</span>
                        </p>
                        ...
                        <a href="{{asset('storage/product/' .$product->filename)}}" download>
                            <button class="btn btn-size btn-outline-2" onclick="return confirm('Download the item?')">PURCHASE NOW</button>
                        </a>
                        <br><br>
                        <p>DETAILS</p>
                        <p>Credit: <span style="color:#6BA3A3;">{{$product->credit}}</span></p>
                        <p>Creative number: <span>00000{{$product->id}}</span></p>
                        <div class="w-50 auto">
                            Product info: <span>{{$product->description}}</span>
                        </div>
                    </div>
                </div>
            </div>
